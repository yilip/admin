		...
		<form id="logoForm" method="post" style="margin-top:20px;">
			...
			<div class="x-form-item">
				...
				<div class="x-form-element">
					<div id="logoDiv">
					    <div class="filelist"><img src="<%=SysConfigCache.getInstance().findValue("admin_logo_url") %>" style="height:100px;"/></div>
			...
			<div class="x-form-item">
				...
				<div class="x-form-element">
					<div id="loginDiv">
					    <div class="filelist"><img src="<%=SysConfigCache.getInstance().findValue("admin_login_url") %>" style="height:250px;"/></div>
