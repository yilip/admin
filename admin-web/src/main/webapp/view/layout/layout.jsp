<!DOCTYPE html>
<%@page import="com.lip.core.service.SysConfigCache"%>
...
<%@page import="com.lip.admin.common.security.AdminRoleGrantedAuthority"%>
...
<style>
.logo{height:60px;line-height:60px;float:left;background:url(<%=SysConfigCache.getInstance().findValue("admin_logo_url") %>) no-repeat left center;font-size:30px;color:#BA8B18;font-family:"隶书";padding-left:220px;font-weight:bold;}
</style>
</head>
